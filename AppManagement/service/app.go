...
func (a *App) StoreInfo() (codegen.AppStoreInfo, error) {
	...
	// apps installed outside the CasaOS store (e.g. imported compose files)
	// have no x-casaos extension - that's expected, not an error.
	ex := a.Extensions[common.ComposeExtensionNameXCasaOS]
