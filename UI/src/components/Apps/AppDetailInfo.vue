    ...
    <header class="modal-card-head">
      <div class="is-flex-grow-1">
        <div class="button is-ghost auto-height pl-0 pt-0 pb-0" @click="close">
          <b-icon class="mr-1" icon="left-outline" size="is-20x20" pack="casa" />
          {{ $t('Back') }}
        </div>
      </div>
    </header>
    ...
    <section id="ss-content" class="modal-card-body">
      ...
      <div class="app-header is-flex pb-4 b-line">
        ...
        <div class="is-flex-grow-1 is-flex is-align-items-center">
          <div>
            <h4 class="title store-title is-4">
            ...
            <p class="description mb-2">
              ...
              >
                ...
                <b-dropdown :triggers="['hover', 'click']" @click.stop>
                  <template #trigger>
                    <div class="casa-down-outline custom-install-dropdown-trigger" />
                  </template>
                  <b-button
                    :disabled="unusable"
                    :loading="appDetailData.id === currentInstallId"
      ...
      <nav class="level is-mobile mt-4">
        <div class="level-item has-text-centered">
          <div>
            ...
            <p class="title">
              <b-icon :icon="getCateIcon(appDetailData.category)" custom-size="mdi-36px" />
            </p>
            <p class="footing is-size-14px">
        ...
        <div class="level-item has-text-centered">
          <div>
            ...
            <p class="title">
              <b-icon custom-size="mdi-36px" icon="account-circle-outline" />
            </p>
            <p class="footing is-size-14px">
              {{ appDetailData.developer }}
            </p>
          </div>
        </div>
        <div class="level-item has-text-centered">
